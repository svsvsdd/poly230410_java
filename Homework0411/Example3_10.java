...
public class Example3_10 {
	...
	public static void main(String[] args) {
		...
		System.out.println(1 + x << 33);	//+연산자 우선순위로 왼쪽 먼저 수행. 1+2 = 3. 3을 이진수로 변환하면 0011인데  <<33번 비트이동. 그런데 int형은 32비트 정수까지 표기되기에 이를 초과하면 남은 부분은 제거됨. 
											//따라서 33 % 32된 값인 1만큼 <<으로 비트이동하여 0011이 0110이 되어 출력값은 6이 나옴
		System.out.println(1 + x < 33);		//+연산자 우선순위로 왼쪽 먼저 수행. 1+2 = 3. 3 < 33 은 참. 결과값 참.
