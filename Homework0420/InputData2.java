...
public class InputData2 {
    ...
    int[] avg; // 국어, 영어, 수학 점수의 평균을 저장하는 배열

    public InputData2(int person) { // 생성자 메소드
        ...
        avg = new int[person]; // person만큼의 크기를 가지는 int 배열 생성
    }
    ...
    public void setData(int i, String name, int kor, int eng, int mat) { // 메소드 오버로딩을 사용한 setData 메소드 정의
        ...
        this.avg[i] = sum[i] / 3; // i번째 학생 국어, 영어, 수학 점수의 평균 계산 후 저장
    }
